...
namespace DATLICHKHAM.Application.ChuyenMuc
{
    public class Add
    {
        ...
        {
            public DLK_ChuyenMucAdd Entity;
        }
            ...
            public async Task<Result<DLK_ChuyenMuc>> Handle(Command request, CancellationToken cancellationToken)
            {
                using (var connection = new SqlConnection(_configuration.GetConnectionString("DefaultConnection")))
                {
                    ...
                    try
                    {
                        ...
                        var result = await connection.QueryFirstOrDefaultAsync<DLK_ChuyenMuc>("SP_Add_ChuyenMuc", parameters, commandType: System.Data.CommandType.StoredProcedure);
