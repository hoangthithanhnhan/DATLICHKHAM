$(document).ready(function () {
    ...
    $('#myTable').DataTable({
        ...
        "columns": [
            ...
            { data: "TenChungChi", "width": "275px", "className": "fw-bold" },
            { data: "TenBacSi", "width": "250px", "className": "text-center" },
            { data: "NgayCap", "width": "200px", "className": "text-center " },
            { data: "NgayHetHan", "width": "200px", "className": "text-center" },
            { data: "SoHieuChungChi", "width": "200px", "className": "text-center " },
            { data: "ToChucCap", "width": "250px", "className": "text-center" },
