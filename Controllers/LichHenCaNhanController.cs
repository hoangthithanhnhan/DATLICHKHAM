...
{
    public class LichHenCaNhanController : Controller
    {
        private readonly ILogger<LichHenCaNhanController> _logger;
        private readonly UserManager<AppUser> _userManager;
        private readonly IMediator _mediator;

        public LichHenCaNhanController(ILogger<LichHenCaNhanController> logger, UserManager<AppUser> userManager, IMediator mediator)
        {
            _logger = logger;
